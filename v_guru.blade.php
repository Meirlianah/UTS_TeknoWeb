...
@section('content')
<h1>DAFTAR PENGAJAR</h1><br>


<a href="/guru/add" class="btn btn-primary btn-sm">Add New</a> <br>
...
<div class="col-md-6"> <br>
    <form action="guru/search" method="GET">
        <input type="text" name="search" placeholder="Search Nama Guru . . ." value="{{ old('search') }}">
...
<table class="table table-bordered table-striped"> <br>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{ $data->mapel }}</td>
            <td><img src="{{ url('foto_guru/'.$data->foto_guru) }}" width="90px"></td>
            <td>
